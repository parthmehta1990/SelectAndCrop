package com.example.selectandcrop.Cropping.data;

import android.net.Uri;

import androidx.annotation.DrawableRes;

import com.example.selectandcrop.Application;
...
public class CropGallery {
   ...
   /* public static List<Uri> getCroppedImageUris() {
        ...
        File saved = Application.getInstance().getFilesDir();
    ...
    public static Uri createNewEmptyFile() {
        return Uri.fromFile(new File(
                Application.getInstance().getFilesDir(),
